sap.ui.require([
  ...
  var sViewName = "com.langure.MetadatosFiori.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "Title of com.langure.MetadatosFiori"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title com.langure.MetadatosFiori"
            });
        }
      }
